...
1. compute Dij matrix: CPU,   54.895s;     5065.91s;        351.7s;      215.3s; 295.0s 505.6s
 2.calculate rho dens: CPU,    0.008s;        0.56s;          1.3s;        1.2s;
         3.transition: CPU,    0.003s;        0.02s;          0.1s;        0.0s;
             4. delta: CPU,    0.008s;        0.78s;          1.4s;        1.5s;
5.find cluster maxima: CPU,    0.005s;        0.02s;          0.1s;        0.1s;
 6. assign all points: CPU,    0.008s;        0.53s;          1.7s;        2.8s;
      7. assign halos: CPU,    0.004s;        0.27s;          0.5s;        0.5s;
TOTAL                : CPU,   58.145s;     5106.25s;        395.0s;      261.2s; 341.0s 547.2s
"""
